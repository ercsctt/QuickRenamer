...
public class Configuration {
    ...
    public String getMessage(String path, HashMap<String, String> toReplace) {
        String message = getString(path);

        if(toReplace != null) {
            StrSubstitutor substitutor = new StrSubstitutor(toReplace);
            message = substitutor.replace(getMessage(path));
        }
